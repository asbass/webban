<%@page import="com.poly.utils.CartItems"%>
					...
					<tbody class="align-middle">
						<c:forEach var="item" items="${cartItems.getItems() }">
							<tr>
									...
									<div class="input-group mx-auto" style="width: 100px;">
										<form action="/cart/modify/${item.get("product").id }" class="quantity" style="display: flex;">
											<div class="input-group-btn">
												<button class="btn btn-sm btn-primary btn-minus"  onclick="(function (){document.querySelector('.quantity').querySelector('.quantity').value = parseInt(document.querySelector('.quantity').querySelector('.quantity').value) - 1;})()"
													type="button">
											...
											<div class="input-group-btn">
												<button class="btn btn-sm btn-primary btn-plus"  onclick="(function (){document.querySelector('.quantity').querySelector('.quantity').value = parseInt(document.querySelector('.quantity').querySelector('.quantity').value) + 1;})()"
													type="button">
								...
								<td class="align-middle">$${Double.valueOf(item.get("product").price)
									* Integer.valueOf(item.get("quantity")) }</td>
								<td class="align-middle"><a href="/cart/remove/${item.get("product").getId() }?url=cart/view"
			...
			<div class="col-lg-4">
				<div class="card border-secondary mb-5">
					...
					<div class="card-footer border-secondary bg-transparent">
						...
						%>
						<a class="btn btn-block btn-primary my-3 py-3">Proceed To
							Checkout</a>
						<%
						}
						%>
