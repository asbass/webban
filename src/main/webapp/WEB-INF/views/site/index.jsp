...
<body>
	...
	<nav aria-label="Page navigation example">
		<ul class="pagination">
			...
			<li><a class="page-link" href="/index?p=${page.number-1}"><i
					class="fa fa-2x fa-angle-left text-dark"></i></a></li>
			<li><a class="page-link" href="/index?p=${page.number+1}"><i
					class="fa fa-2x fa-angle-right text-dark"></i></a></li>
				...
				<div class="col-lg-4 col-md-6 pb-1">
					...
					<div class="cat-item d-flex flex-column border mb-4"
						...
						<a href="edit/${sp.id}"
							...
							src="/images/${sp.image}" alt="">
						</a>
						<h5 class="font-weight-semi-bold m-0">${sp.name}</h5>
						<h5 class="font-weight-semi-bold m-0">${sp.price}</h5>
