						...
						<div class="navbar-nav ml-auto py-0">
							<a href="" class="nav-item nav-link">Login</a> <a href=""
								...
								<a href="#" class="nav-link" data-toggle="dropdown"
									aria-expanded="false">tai khoan <i
									class="fa fa-angle-down float-right mt-1"></i></a>
								<div
									class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
									<%-- <c:if test="${null account }">
										<a href="/login" class="dropdown-item">Đăng nhập</a>
										<a href="/registrator" class="dropdown-item">Đăng kí</a>
										<a href="/forget" class="dropdown-item">Quên mật khẩu</a>
									</c:if>
									<c:if test="${account }">
									...
									<a class="dropdown-item" href="/logoff">Đăng xuất</a>
										...
										<%= request.getAttribute("user") != null ? "<div class='navbar-nav ml-auto py-0'><a href='/logoff' class='nav-item nav-link'>Logout</a></div>" : "<div class='navbar-nav ml-auto py-0'><a href='/login' class='nav-item nav-link'>Login</a> <a href='/registrator' class='nav-item nav-link'>Register</a></div>"%>
			...
			<div class="col-lg-3 col-md-12">
				...
				<div class="border-bottom mb-4 pb-4">
					...
					<form action="/shop/price" method="post">
						<input name="min" placeholder="Price min?"class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3"/>
						<input name="max" placeholder="Price max?"class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3"/>	
					...
					<div class="col-lg-4 col-md-6 col-sm-12 pb-1">
						<div class="card product-item border-0 mb-4">
							<div
								...
								<img class="img-fluid w-100"  src="images/${sp.image}" alt="">
							</div>
							<div
							...
							<div
								...
								<a href="/edit/${sp.id}" class="btn btn-sm text-dark p-0"><i
									class="fas fa-eye text-primary mr-1"></i>View Detail</a>  <a
										href="/cart/add/${sp.id}?quantity=1&url=shop" class="btn btn-sm text-dark p-0"><i
						...
						<nav aria-label="Page navigation">
							<ul class="pagination justify-content-center mb-3">
								<li class="page-item "><a class="page-link"
									href="/shop/price?p=${page.number-1}" aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
										<span class="sr-only">Previous</span>
								</a></li>
								<li class="page-item active"><a class="page-link" href="#">1</a></li>
								<li class="page-item"><a class="page-link" href="#">2</a></li>
								<li class="page-item"><a class="page-link" href="#">3</a></li>
								<li class="page-item"><a class="page-link" href="/shop?p=${page.number+1}"
